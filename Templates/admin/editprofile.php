            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input type="text" name="firstName" id="inputFirstName" class="form-control"
                        value="<?php if(isset($_SESSION['user']->first_name)){echo $_SESSION['user']->first_name;}else{echo "";}?>"
                        placeholder="Berke">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input type="text" name="lastName" id="inputLastName" class="form-control"
                        value="<?php if(isset($_SESSION['user']->last_name)){echo $_SESSION['user']->last_name;}else{echo "";}?>"
                        placeholder="Ozturk">
                </div>
            </div>
